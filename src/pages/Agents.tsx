        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="mt-2 text-[11px] leading-relaxed text-dim">
              ...
              компилятором (<span className="font-mono text-mut">csc.exe</span>) под вашу архитектуру, запишет сервер и токен в{' '}
              <span className="font-mono text-mut">agent.conf</span> и поставит его службой с автозапуском — в конце сам проверит,
              подключился ли агент. Go и любые другие инструменты на машине не нужны.
            </p>
          </div>
        ...
        <Panel title="Подключение реального агента (Windows)" icon={Terminal} delay={40}>
          <div className="space-y-3">
            <p className="text-[12.5px] leading-relaxed text-mut">
              ...
              Установщик скачает исходник с ядра, скомпилирует его встроенным в Windows компилятором, запишет сервер и токен
              в <span className="font-mono text-mut">C:\ProgramData\pluto\agent.conf</span> и поставит агент службой (exe запускается без
              аргументов — установке негде сломаться). В конце установщик сам дождётся подключения и скажет, в сети ли агент.
            </p>
            <CopyBlock
