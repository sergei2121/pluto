        ...
        <KpiTile
          ...
          extra={
            <div className="flex items-end gap-2">
              <div className="h-[30px] flex-1"><FleetSpark values={fleetSpark} /></div>
              <span className="pb-0.5 font-mono text-[10px] text-dim">доступность</span>
            </div>
          }
        />
        <KpiTile
