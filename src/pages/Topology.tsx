...
// Упрощённый вид по умолчанию: агенты с количеством IP под пингом.
// Ниже — полная карта инфраструктуры.
    ...
    <div className="space-y-4">
      ...
      <div className="rise relative overflow-hidden rounded-xl border border-line bg-panel/90 p-5">
        ...
        <div className="relative flex items-center justify-between">
          <div>
            <h2 className="font-display text-[15px] font-bold text-ink">Топология · сводка</h2>
            <p className="text-[11.5px] text-dim">агенты и количество IP под пингом</p>
          </div>
        ...
        <div className="mt-5 grid grid-cols-2 gap-3 md:grid-cols-4">
          ...
          <div className="rounded-lg border border-line bg-raised/50 p-3 text-center">
            ...
            <div className="text-[10.5px] uppercase tracking-[0.12em] text-dim">IP под пингом</div>
          </div>
          <div className="rounded-lg border border-line bg-raised/50 p-3 text-center">
          ...
          {agents.map((a) => {
            ...
            return (
              <button key={a.id} onClick={() => store.nav('agents', a.name)}
                className="flex w-full items-center gap-3 rounded-lg border border-line bg-raised/40 px-4 py-2.5 text-left transition-all hover:border-vio/40 hover:bg-raised/70">
                ...
                <div className="text-right">
                  ...
                  <div className="font-mono text-[9.5px] text-dim">IP</div>
                </div>
              </button>
            );
          })}
